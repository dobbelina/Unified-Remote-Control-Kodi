...
<layout>
  <grid>
    <row>
      ...
      <button Text="Page Down" onTap="Kodi_Page_Down" />
    ...
    <row>
      ...
      <button icon="stop" onTap="Kodi_Stop" onhold="Kodi_Watched" color="#f5f576" />
    ...
    <row>
	  ...
	  <button Text="Sub On/Off/Pos" onTap="Kodi_Subon" onhold="Kodi_Subpos" color="#f5f576" />
	  <button Text="Codec" onTap="Kodi_Codec" onhold="Kodi_Codec2" color="#f5f576" />
    </row>
    <row>
	 ...
	 <row>
      ...
      <button icon="windows" onTap="Kodi_Windows" onhold="switch" color="#f5f576" />
